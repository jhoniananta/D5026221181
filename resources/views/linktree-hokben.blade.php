...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="{{asset('img/linktree-logo-icon.png')}}" />
    <link rel="stylesheet" href="{{asset('css/style-hokben.css')}}" />
    <title>HokBen</title>
  </head>
  <body>
    <div class="jhoni-container">
      <div class="jhoni-container-top">
        <img
          src="{{asset('img/icon-hokben.png')}}"
          alt="HokBen"
          class="jhoni-icon-hokben"
        />
        <h1>HokBen</h1>
        <div class="jhoni-container-top-text">
          <h2>
            Feel the Amazing moment with HokBen You can order & follow our
            Social Media
          </h2>
        </div>
      </div>
      <div class="jhoni-container-main">
        <div class="jhoni-link">
          <a href="https://www.hokben.co.id" target="_blank">
            <p>Enjoy your Best Bento now!!!</p>
          </a>
        </div>
        <div class="jhoni-link">
          <a href="https://update.hokben.co.id" target="_blank">
            <p>Give Yours Feedback</p>
          </a>
        </div>
        <div class="jhoni-link">
          <a href="https://www.instagram.com/hokben_id/" target="_blank">
            <p>Follow Minho Now!!!</p>
          </a>
        </div>
        <div class="jhoni-link">
          <a href="https://www.facebook.com/HokBenID" target="_blank">
            <p>Be our Facebook Fans</p>
          </a>
        </div>
        <div class="jhoni-link">
          <a href="https://www.tiktok.com/@hokben_id" target="_blank">
            <p>Let's see our Tiktok</p>
          </a>
        </div>
        <div class="jhoni-link">
          <a href="https://www.twitter.com/HokBen" target="_blank">
            <p>Tweet your Moments with Hokben</p>
          </a>
        </div>
        <div class="jhoni-link">
          <a
            href="https://www.youtube.com/@HokBen_ID?sub_confirmation=1"
            target="_blank"
          >
        ...
        <div class="jhoni-link">
          <img
            src="https://ugc.production.linktr.ee/N9vQu5aoSh6ERsM6FnWK_unnamed.png?io=true&size=thumbnail-stack-v1"
            alt="hokben"
          />
          <a
            class="jhoni-link-a"
            href="https://play.google.com/store/apps/details?id=id.co.hokben.revamp&pli=1"
            target="_blank"
          >
            <p>Get HokBen Apps on Android</p>
          </a>
        </div>
        <div class="jhoni-link">
          <img
            src="https://ugc.production.linktr.ee/Srb0t0RjTGqr2Dx26WSh_1200x630wa.png?io=true&size=thumbnail-stack-v1"
            alt="hokben"
          />
          <a
            class="jhoni-link-a"
            href="https://apps.apple.com/id/app/hokben-app/id1501134613?l=en"
            target="_blank"
          >
            <p>Download HokBen Apps on iOs</p>
          </a>
        </div>
      </div>
      <div class="jhoni-container-bottom">
        <!-- Copy icon linktree footer bar -->
        <a
